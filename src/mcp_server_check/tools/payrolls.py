...
async def approve_payroll(
    ...
    Args:
        payroll_id: The Check payroll ID.
        preview_started_at: Optional ISO-8601 timestamp from the payroll's
            preview_started_at field (e.g. "2019-06-29T18:26:56.848920Z").
            When provided, approval fails with preview_superseded if the
            payroll was re-previewed after this timestamp.
    """
    return await check_api_post(
        ctx,
